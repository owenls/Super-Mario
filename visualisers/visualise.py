...
=======
    plt.annotate(f"Max at Step: {steps[max_step_reward_idx]} with Reward: {s_rewards[max_step_reward_idx]}", 
>>>>>>> edbf445 (training finished):visualisers/visualise.py
...
=======
    plt.annotate(f"Max at Episode: {episodes[max_episode_reward_idx]} with Reward: {e_rewards[max_episode_reward_idx]}", 
>>>>>>> edbf445 (training finished):visualisers/visualise.py
...
=======
    episode_rewards = read_data_from_file("/Users/jlumagbas/Desktop/General/Projects Repository/Super-Mario/decay_1m/dec_un_steps_1000000.txt")
    step_rewards = read_data_from_file("/Users/jlumagbas/Desktop/General/Projects Repository/Super-Mario/decay_1m/dec_un_steps_1000000.txt")
>>>>>>> edbf445 (training finished):visualisers/visualise.py
